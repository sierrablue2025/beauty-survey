...
export const surveyFull: SurveyDefinition = {
  ...
  questions: [
    ...
    {
      id: "q9",
      label: "現在使っているブランドがあれば教えてください",
      type: "text",
      required: false,
      description: "わかる範囲でご記入ください。",
      placeholder: "例：資生堂、無印良品、SK-II など",
    },
    {
      id: "q10",
      label: "理想の肌や髪の状態を自由に教えてください",
      type: "text",
      required: false,
      description: "なりたいイメージがあれば自由にご記入ください。",
      placeholder: "例：乾燥しにくく、毛穴の目立たない透明感のある肌になりたい",
    },
  ],
};
